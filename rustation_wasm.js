...
export class InputState {
    ...
    static __wrap(ptr) {
        ...
        obj.__wbg_ptr = ptr;
        InputStateFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
...
const PsxEmulatorFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
...
export class PsxEmulator {
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        PsxEmulatorFinalization.unregister(this);
        return ptr;
    }
    ...
    load_bios(bios_data) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.psxemulator_load_bios(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
    ...
    run_frame() {
        const ret = wasm.psxemulator_run_frame(this.__wbg_ptr);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    start() {
        wasm.psxemulator_start(this.__wbg_ptr);
    }
    stop() {
        wasm.psxemulator_stop(this.__wbg_ptr);
    }
    /**
     * @returns {boolean}
     */
     ...
     * @param {boolean} pressed
     */
    handle_keyboard_event(event, pressed) {
     ...
     */
    get_save_state() {
        const ret = wasm.psxemulator_get_save_state(this.__wbg_ptr);
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
        return v1;
    }
    /**
     * @param {Uint8Array} _state
     */
    load_save_state(_state) {
        const ptr0 = passArray8ToWasm0(_state, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.psxemulator_load_save_state(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_error_1fff0d329dcd64a2 = function(arg0, arg1) {
    ...
    imports.wbg.__wbg_log_313dfbfe1c79ff76 = function(arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('rustation_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
